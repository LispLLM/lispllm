...
export default function S8Scale() {
  ...
  return (
    <section id="sec-8" className="mx-auto max-w-measure px-4 py-16 font-mono">
      ...
      <div className="mb-6 space-y-3 text-sm leading-6 text-dim">
        <p>
          ...
          pieces); a KV cache (§0 recomputes the whole context for every character, which is O(T²) —
          real systems cache k and v per layer); instruction tuning and RLHF (it continues text, it
          doesn't converse); mixture-of-experts; and above all, scale
          <Cite n={11} />.
        </p>
        <p>
